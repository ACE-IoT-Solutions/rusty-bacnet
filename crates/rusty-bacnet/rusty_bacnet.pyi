...
class RouterScPort:
    ...
    def network_number(self) -> int: ...
    @property
    def primary_hub(self) -> str: ...
    @property
    def local_vmac(self) -> bytes: ...
    @property
    ...
    @property
    def failover_hub(self) -> Optional[str]: ...
    @property
    ...
    @property
    def reconnect_forever(self) -> bool: ...


class RouterVirtualPort:
    def __init__(self, network_number: int, name: str, mac: int) -> None: ...
    @property
    def network_number(self) -> int: ...
    @property
    def name(self) -> str: ...
...
class RouterPortHealth:
    ...
    @property
    def active_hub(self) -> Optional[str]: ...
    @property
...
class RouterRouteEntry:
    ...
    @property
    def next_hop_mac(self) -> bytes: ...
    @property
    def reachability(self) -> str: ...
    @property
    def last_seen_age_s(self) -> Optional[float]: ...
    @property
    def busy_remaining_s(self) -> Optional[float]: ...
    @property
    def flap_count(self) -> int: ...
    @property
    def last_port_change_age_s(self) -> Optional[float]: ...
...
class BACnetRouter:
    ...
    def from_ports(
        cls,
        ports: list[Union[RouterBipPort, RouterScPort, RouterVirtualPort]],
    ) -> BACnetRouter: ...
    async def start(self) -> None: ...
    async def stop(self) -> None: ...
    async def local_address(self) -> str: ...
    async def port_counters(self) -> list[RouterPortCounters]: ...
    async def port_health(self) -> list[RouterPortHealth]: ...
    async def routing_table(self) -> list[RouterRouteEntry]: ...
